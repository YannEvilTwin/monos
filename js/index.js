...
Pace.on('done', function () {
    ...
    gsap.to('#preloader', 1.5, {
        ...
        onComplete: function () {
            ...
            //TODAS LAS ANIMACIONES QUE TENDRÁN LUGAR DESPUÉS DE CARGAR LA PÁGINA
            ...
            //TODAS LAS ANIMACIONES QUE TENDRÁN LUGAR DURANTE EL SCROLL
            ...
            //ANIMACION PARA LA SECCION SONGS
...
$(function () {
    $('.menu-bar').on('click', function () {
        ...
        gsap.to('.navigation-content .opacity', .5, {
            opacity: 1,
            stagger: .1,
            delay: 1
        })
    ...
    $('.navigation-close').on('click', function () {
        gsap.to('.navigation-content ul li', .5, {
            opacity: 0,
            stagger: -.1
        })
        gsap.to('.navigation-content .opacity', .5, {
